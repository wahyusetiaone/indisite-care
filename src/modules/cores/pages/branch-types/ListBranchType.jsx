...
import { fetchAllBranchTypes } from "@/services/cores/BranchTypeService"; 
import { useLoaderTablePagination } from "@/helper/loaderTablePagination"; 

const ListBranchType = () => {
    const {
        data, 
        loading, 
        pagination,
        ...
        <div className="col-lg-12">
            <div className="card">
                <div className="card-header border-bottom">
                    {/* Card Title */}
                    <h4 className="card-title mb-3">List Branch Type</h4>
