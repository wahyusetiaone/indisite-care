...
export default function CreateVisitType() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err?.message || "Failed to create visit type");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="col-lg-12">
      <div className="card">
        <div className="card-header">
          <h5 className="card-title mb-0">Input Visit Type</h5>
        </div>
        <div className="card-body">
          ...
          >
            ...
            <div className="col-md-12">
              ...
              {success && <div className="alert alert-success mt-2">Visit type created successfully!</div>}
